 ...
 */
var Trigger = {
    BLOCK_BREAK          : { name: '方块被破坏 付费版 Block Break',          container: true, construct: TriggerBlockBreak,        premium: true },
    BLOCK_PLACE          : { name: '方块被放置 付费版 Block Place',          container: true, construct: TriggerBlockPlace,        premium: true },
    CAST                 : { name: '技能释放 Cast',                 container: true, construct: TriggerCast               },
    CLEANUP              : { name: '玩家离线或未学习技能 Cleanup',              container: true, construct: TriggerCleanup            },
    CROUCH               : { name: '玩家下蹲状态变化 Crouch',               container: true, construct: TriggerCrouch             },
    DEATH                : { name: '玩家死亡 Death',                container: true, construct: TriggerDeath              },
    ENVIRONMENT_DAMAGE   : { name: '玩家遭受环境伤害 付费版 Environment Damage',   container: true, construct: TriggerEnvironmentDamage, premium: true },
    INITIALIZE           : { name: '初始化 Initialize',           container: true, construct: TriggerInitialize         },
    KILL                 : { name: '击杀事件 Kill',                 container: true, construct: TriggerKill               },
    LAND                 : { name: '玩家着地 Land',                 container: true, construct: TriggerLand               },
    LAUNCH               : { name: '玩家发射投掷物 Launch',               container: true, construct: TriggerLaunch             },
    MOVE                 : { name: '玩家移动 Move',                 container: true, construct: TriggerMove,              premium: true },
    PHYSICAL_DAMAGE      : { name: '玩家造成物理伤害 Physical Damage',      container: true, construct: TriggerPhysicalDamage     },
    SKILL_DAMAGE         : { name: '玩家造成技能伤害 Skill Damage',         container: true, construct: TriggerSkillDamage        },
    TOOK_PHYSICAL_DAMAGE : { name: '玩家受到物理伤害 Took Physical Damage', container: true, construct: TriggerTookPhysicalDamage },
    TOOK_SKILL_DAMAGE    : { name: '玩家受到技能伤害 Took Skill Damage',    container: true, construct: TriggerTookSkillDamage    }
};
